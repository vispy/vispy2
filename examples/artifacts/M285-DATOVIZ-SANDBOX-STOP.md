...
- Source and isolated-wheel suites each passed 765 tests. Strict mypy, Ruff, documentation Python
  blocks, local links, wheel builds, import isolation, and diff checks passed.
...
After committing and integrating the implementation as GSP `4ff1614` and VisPy2 `482f494`, Mission
...
manifest records exact source revisions plus script, wheel, and artifact hashes. This resolves the
artifact-regeneration stop without reclassifying the sandbox denial as a product defect.
