...
class EmissionFeature(StrEnum):
    ...
    MESHVISUAL_MATERIAL_TEXTURE2D_UNLIT_V1 = "vispy2.emit.meshvisual.material.texture2d_unlit.v1"
    MESHVISUAL_TEXTURE_FILTER_LINEAR_V1 = "vispy2.emit.meshvisual.texture_filter.linear.v1"
